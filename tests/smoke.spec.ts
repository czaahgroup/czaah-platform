...
test.describe('auth wall', () => {
  for (const path of ['/admin', '/dashboard', '/partner-network', '/admin/mail/mailboxes', '/admin/crm/contacts', '/admin/recruitment/orders', '/admin/crm/deals', '/admin/construction/projects', '/admin/trading/trades', '/admin/control-plane']) {
  ...
  for (const api of ['/api/mail/threads', '/api/crm/contacts', '/api/crm/companies', '/api/crm/timeline?type=contact&id=x', '/api/recruitment/orders', '/api/recruitment/overview', '/api/recruitment/candidates', '/api/deals', '/api/deals/lookup', '/api/construction/projects', '/api/construction/overview', '/api/trading/trades', '/api/trading/overview', '/api/admin/control-plane']) {
