  ...
  const sidebarContent = (
    <>
      ...
      <div style={{ flex: 1, padding: '16px 12px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '1px' }}>
        ...
        <NavLink href="/admin/risk" label="Risk Radar" icon="crisis_alert" />
        ...
        <NavLink href="/admin/verification" label="Verification" icon="verified" />
        <NavLink href="/admin/homepage" label="Homepage" icon="home" />
        ...
        <NavLink href="/admin/media" label="Media Library" icon="perm_media" />
        <NavLink href="/admin/portal-content" label="Portal Content" icon="tune" />
