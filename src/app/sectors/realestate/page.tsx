      ...
      <div className="page-wrap">
        ...
        <section className="py-32 px-5 md:px-24 bg-surface fade-in">
          <div className="max-w-[1600px] mx-auto">
            ...
            <p className="raleway-text text-on-surface-variant text-base leading-relaxed max-w-3xl mb-12">CZAAH is an international real estate investment facilitation group, with structured access, local partnerships, and end-to-end transaction support across Pakistan and leading global markets.</p>
