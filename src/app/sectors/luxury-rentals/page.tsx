...
const fleetData = [
  { category: 'sedan', classLabel: 'Executive Sedan', name: 'Mercedes-Benz S-Class', specs: ['4 passengers', 'Chauffeur or self-drive', 'Wi-Fi & privacy glass'], desc: "The global standard for executive travel. Latest S-Class with premium interior, rear entertainment, and complete discretion. Available chauffeur-driven or self-drive across London and the UK.", img: 'https://placehold.co/700x320/0a0a0a/C9A84C?text=Mercedes+S-Class' },
  ...
  { category: 'suv', classLabel: 'Luxury SUV', name: 'Toyota Land Cruiser 300', specs: ['6 passengers', 'All-terrain', 'Chauffeur or self-drive'], desc: "One of the world's most capable luxury SUVs. Engineered for every road condition, from city streets to countryside estates. Available chauffeur-driven or self-drive for corporate and leisure travel alike.", img: 'https://placehold.co/700x320/0a0a0a/C9A84C?text=Land+Cruiser+300' },
      ...
      <div className="page-wrap">
        ...
        <section className="py-32 px-5 md:px-24 bg-surface fade-in">
          <div className="max-w-[1200px] mx-auto">
            ...
            <p className="raleway-text text-on-surface-variant text-base mb-10 leading-relaxed">Eight classes of vehicle, available chauffeur-driven or self-drive. One standard of excellence.</p>
