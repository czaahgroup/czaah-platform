...
const verticals = [
  ...
  { num: '07', name: 'Construction & Development', model: 'Infrastructure · Commercial · UK/Gulf', description: 'Civil infrastructure, commercial buildings, and Special Economic Zone development across Pakistan, the UK, and the Gulf — including CPEC corridor projects, delivered through trusted construction partners.', slug: 'construction', coreFocus: true },
