      ...
      <main className="bg-surface min-h-screen">
        ...
        <section className="relative min-h-[60dvh] md:min-h-[70dvh] flex items-end bg-cover bg-center" style={{ backgroundImage: "url('/Images/Insights.jpg')" }}>
          ...
          <div className="relative z-10 py-32 px-5 md:px-24 max-w-[1600px] mx-auto w-full">
            ...
            <p className="raleway-text text-xs font-semibold tracking-[0.2em] uppercase text-primary mb-6">Weekly Intelligence</p>
            ...
            <p className="raleway-text text-on-surface-variant text-lg leading-relaxed max-w-2xl">Strategic intelligence on Pakistan&rsquo;s investment landscape &mdash; mining, real estate, construction, and beyond. Published every Friday.</p>
          </div>
        </section>
