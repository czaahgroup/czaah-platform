      ...
      <main className="bg-surface min-h-screen">
        ...
        <section className="relative min-h-[60dvh] md:min-h-[70dvh] flex items-end bg-cover bg-center" style={{ backgroundImage: "url('/Images/Investments.jpg')" }}>
          ...
          <div className="relative z-10 py-32 px-5 md:px-24 max-w-[1600px] mx-auto w-full">
            ...
            <p className="raleway-text text-on-surface-variant text-lg leading-relaxed max-w-2xl mb-10">Pre-vetted, legally structured opportunities across Pakistan&apos;s highest-growth sectors &mdash; each assessed for feasibility, regulatory compliance, and investor-ready execution.</p>
        ...
        <section className="py-32 px-8 md:px-24 bg-surface" id="iv-dealflow">
          <div className="max-w-[1600px] mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="raleway-text text-on-surface-variant text-base max-w-[700px] mx-auto">Pre-vetted, structured investment opportunities across Pakistan&apos;s highest-growth sectors. Each opportunity is assessed for regulatory compliance, financial viability, and defined exit strategy.</p>
            </div>
