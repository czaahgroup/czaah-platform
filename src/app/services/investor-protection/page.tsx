        ...
        <section className="relative min-h-[70dvh] flex items-end bg-cover bg-center" style={{ backgroundImage: "url('/Images/Investor-Protection.jpg')" }}>
          ...
          <div className="relative z-10 py-32 px-5 md:px-24 max-w-[1600px] mx-auto w-full">
            ...
            <p className="raleway-text text-lg md:text-xl text-on-surface-variant max-w-3xl leading-relaxed mb-10">
              Protecting international investors through comprehensive due diligence, legal safeguards, transparent reporting, and risk management — ensuring every investment in Pakistan is secure, verified, and properly structured.
            </p>
        ...
        <section className="py-32 px-5 md:px-24">
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="space-y-4">
              {[
                { icon: 'visibility', title: 'Local Intelligence', desc: "Deep on-the-ground knowledge of Pakistan's regulatory, legal, and commercial landscape. We identify risks that remote due diligence simply cannot uncover — protecting you from hidden exposures." },
                { icon: 'gavel', title: 'Legal Expertise', desc: "Access to Pakistan's leading commercial law firms and international arbitration specialists. Our contracts are drafted to protect investor interests across multiple jurisdictions and enforcement regimes." },
