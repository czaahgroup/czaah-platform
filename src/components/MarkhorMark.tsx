// Shared Markhor logo mark — used by the main site Navbar and the
// property.czaah.com portal so both stay visually identical.

export function MarkhorMark({ className = 'markhor-mark' }: { className?: string }) {
  return (
    <svg className={className} viewBox="-5 -12 100 128" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
